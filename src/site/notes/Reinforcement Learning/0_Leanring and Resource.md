...
* 自定义环境
	...
	* [Using Custom Environments — Stable Baselines](https://stable-baselines.readthedocs.io/en/master/guide/custom_env.html) ，stable-basline 提供的自定义环境的教学，基本也是按照 Gym 的设计流程和模式，提供了一个编写自己环境的 [dome](https://github.com/openai/gym/blob/master/docs/creating-environments.md) 可以在在线笔记本中运行，以此学习如何建立一个定制环境。
